...
public partial class Faculty_changePassword : System.Web.UI.Page
{
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string oldpass = csedept.ExecuteScalar("Select Password from FacultyTbl where Id='" + Aid + "' and Password='" + OldPassword + "' and IsActive='1'");
            if (OldPassword == oldpass)
            {
                string NewPassword = txtNewPassword.Text;
                csedept.ExecuteQuery("Update FacultyTbl set Password ='" + NewPassword + "' where Id='" + Aid + "' ");
